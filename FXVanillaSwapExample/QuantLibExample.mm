...
@implementation QuantLibExample

@synthesize quote;
@synthesize strikePrice;
@synthesize foreignRate;
@synthesize dividentYieldValue;
@synthesize riskFreeRateValue;
...
//-(void) calculateBlack {
//    
//    double values[26] = { 18.805, 18.805, 18.805, 18.805, 18.805, 18.665,
//        18.665, 18.665, 18.665, 18.665, 18.665, 18.665, 18.665, 18.665,
//        18.665, 18.665, 18.665, 18.665, 18.665, 18.665, 18.665, 18.665,
//        18.665, 18.665, 18.665, 18.665 };
//    
//    [self testingBlackScholesCalculatorMulti:values];
//    
//}


//
//-(void) testingBlackScholesCalculatorMulti:(double *) values{
//    
//	for (int var = 0; var < sizeof(values); ++var) {
//		double S0 = values[var];
//		double K=105.0;
//		double rd=0.034, rf=0.021, tau=0.5, vol=0.177;
//		double domDisc=std::exp(-rd*tau), forDisc=std::exp(-rf*tau);
//		double stdDev=vol*std::sqrt(tau);
//        
//		boost::shared_ptr<QuantLib::PlainVanillaPayoff> vanillaPayoffPut(
//                                                                         new QuantLib::PlainVanillaPayoff(QuantLib::Option::Put,K));
//        
//		boost::shared_ptr<QuantLib::AssetOrNothingPayoff> aonPayoffCall(
//                                                                        new QuantLib::AssetOrNothingPayoff(QuantLib::Option::Call,K));
//        
...
//        
//        NSLog(@"hmm %f",vanillaPutPricer.value());
//        
